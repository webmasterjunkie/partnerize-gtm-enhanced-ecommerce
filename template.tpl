...
{
  "displayName": "Partnerize Enhanced eCommerce Tag",
  "categories": [
    "AFFILIATE_MARKETING",
    "ADVERTISING",
    "CONVERSIONS",
  ...
  "description": "This is the enhanced eCommerce tracking tag for Partnerize. This is used to send your purchase marketing events to Partnerize.",
  "securityGroups": [],
...
[
  ...
  },
  {
    "simpleValueType": true,
    "name": "VoucherCode",
    "checkboxText": "Include Voucher Code",
    "type": "CHECKBOX"
  },
  {
    "type": "LABEL",
...
var url = trackingDomain + 'conversion/tmethod:1/tplatform:4/tdetail:7/campaign:' + encodeUriComponent(data.CampaignID) + '/';
